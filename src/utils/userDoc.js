 ...
 *
 * `invitedVia` is write-once provenance: the invite token this row was created against. It is stamped
 * ONLY on create (`isNew`) and only when supplied — never on the lastSeenAt
